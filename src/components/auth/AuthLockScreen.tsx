    ...
    >
      ...
      >
        ...
        <div style={{ position: 'relative', display: 'inline-flex', justifyContent: 'center', alignItems: 'center', marginBottom: '24px' }}>
          ...
          >
            <Lock size={30} color="var(--theme-secondary)" strokeWidth={2.2} />
          </div>
        </div>
        ...
        <p style={{
          ...
          Sign in to access your <strong>Trading Journal</strong>, multi-account performance analytics, and risk calculators.
        </p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <button
            ...
            style={{
              ...
              justifyContent: 'center',
              gap: '8px',
              boxShadow: '0 4px 20px color-mix(in srgb, var(--theme-secondary-strong) 40%, transparent)'
            }}
          >
          ...
          >
            ...
            <span>Quick Sign In via Discord</span>
          </button>
